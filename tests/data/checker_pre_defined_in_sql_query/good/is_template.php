<?php
	 ...
	 * $Id: test.php 2 2010-07-28 14:37:15Z asubbota $
	 */
	$parser = $render = $source = '';
	$plist = array('Default', 'BBCode', 'Cowiki', 'Doku', 'Jira', 'Mediawiki', 'Tiki', 'X-choice');
	...
	function bldHtml($result, $plist, $rlist, $elist) {
		...
		$_REQUEST['source'] = stripslashes(htmlspecialchars($_REQUEST['source']));
		return <<<EOT
