<?php
/**
 * каждая из веток условного ветвления исполняется в паралельном потоке - с изолированной областью значений переменных @todo реализовать прогон всех вариантов до конца (сейчас после
 * разделения и выполнения под ветки скоупы уничтожаются, что неверно, т.к. после условной ветки скрипт выполняется дальше)
